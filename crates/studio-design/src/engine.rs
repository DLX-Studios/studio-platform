...
use crate::{
    ...
    model::{
        Actor, Alignment, DeletionTombstone, DesignNode, DesignNodeSource, DesignerDiagnostic,
        DiagnosticSeverity, InteractionAction, LayoutProperties, Length, LengthUnit, NodeId,
        NodeParent, OperationId, Placement, ProjectId, PropertyValue, RevisionId, RevisionMetadata,
