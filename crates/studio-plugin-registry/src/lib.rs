...
pub use descriptor::{
    ...
    DESCRIPTOR_SCHEMA_VERSION, DeclaredCapability, DescriptorPolicy, DescriptorPublisher,
    DescriptorSignature, HookBudget, HookDeclaration, LifecycleHook, MAX_DESCRIPTOR_BYTES,
    MAX_HOOK_MEMORY_BYTES, MAX_HOOK_TIME_MS, PluginDescriptorV1, PrimitiveInputValue, SelectOption,
    SettingsField, SettingsFieldType, SettingsGroup, SignedDescriptorEnvelope,
    TemplateContribution, TemplateScreen, TemplateToken, parse_descriptor_envelope,
