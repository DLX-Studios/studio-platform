...
if (!hasCol("dedicated"))
  db.exec("ALTER TABLE machines ADD COLUMN dedicated INTEGER NOT NULL DEFAULT 0");
if (!hasCol("volume_gb"))
  db.exec("ALTER TABLE machines ADD COLUMN volume_gb INTEGER NOT NULL DEFAULT 0");
if (!hasCol("image"))
  db.exec("ALTER TABLE machines ADD COLUMN image TEXT NOT NULL DEFAULT ''");
if (!hasCol("ssh_key_ids"))
  db.exec("ALTER TABLE machines ADD COLUMN ssh_key_ids TEXT NOT NULL DEFAULT ''");
if (!hasCol("daemon_ready"))
  db.exec("ALTER TABLE machines ADD COLUMN daemon_ready INTEGER NOT NULL DEFAULT 0");
if (!hasCol("daemon_token"))
  db.exec("ALTER TABLE machines ADD COLUMN daemon_token TEXT NOT NULL DEFAULT ''");
...
export { getSetting, setSetting, isConfigured, listMachines, getMachine, createMachine, updateMachine, deleteMachine, setDaemonReady, getMachineByDaemonToken, machineTag, startSession, getOpenSession, endSession, listSessions, addEvent };

//# debugId=8C2EB7497A67F94564756E2164756E21
