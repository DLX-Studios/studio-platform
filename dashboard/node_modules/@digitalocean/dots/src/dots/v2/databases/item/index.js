...
// @ts-ignore
import { AutoscaleRequestBuilderRequestsMetadata } from './autoscale/index.js';
// @ts-ignore
...
// @ts-ignore
import { Do_settingsRequestBuilderRequestsMetadata } from './do_settings/index.js';
// @ts-ignore
 ...
 */
// @ts-ignore
export function serializeWithDatabase_cluster_uuGetResponse(writer, withDatabase_cluster_uuGetResponse = {}, isSerializingDerivedType = false) {
    if (!withDatabase_cluster_uuGetResponse || isSerializingDerivedType) {
        return;
    }
