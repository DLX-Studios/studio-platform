...
import { bin2hex, encoder, getScope, makeDateLong, makeDateShort, sha256digestHex } from "./helpers.js";
...
/** returns the key used for calculating signature */ async function getSigningKey(date, region, secretKey) {
...
/** generate a credential string  */ function getCredential(accessKey, region, requestDate) {
