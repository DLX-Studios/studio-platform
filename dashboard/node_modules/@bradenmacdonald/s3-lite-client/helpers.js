 ...
 */ /** A TextEncoder is stateless, so we share a single one instead of allocating one per call. */ export const encoder = new TextEncoder();
 ...
 */ export const isValidObjectName = (n)=>isValidPrefix(n) && n.length > 0;
 ...
 */ export function bin2hex(binary) {
...
/** Create a Date string with format: 'YYYYMMDDTHHmmss' + Z */ export function makeDateLong(date) {
  // toISOString() gives format like: '2017-08-07T16:28:59.889Z'
  return date.toISOString().replace(/[-:]/g, "").slice(0, 15) + "Z";
}
/** Create a Date string with format: 'YYYYMMDD' */ export function makeDateShort(date) {
