import { encoder, getVersionId, sanitizeETag } from "./helpers.js";
...
/** The maximum number of parts in a multi-part upload. https://docs.aws.amazon.com/AmazonS3/latest/userguide/qfacts.html */ const maxParts = 10_000;
/**
 ...
 */ export async function uploadSingleRequest({ client, metadata, ...requestArgs }) {
 ...
 */ export class ObjectUploader extends WritableStream {
  getResult;
  constructor({ client, bucketName, objectName, partSize, metadata }){
    ...
    let uploadId;
    const etags = [];
    /** If an error occurs during multi-part uploads, we temporarily store it here. */ let multiUploadError;
    /**
...
/** Initiate a new multipart upload request. */ async function initiateNewMultipartUpload(options) {
  const method = "POST";
