 ...
 */
export declare const isUntypedBoolean: (node: UntypedNode) => node is UntypedBoolean;
/**
 ...
 */
export declare const createUntypedBoolean: (value: boolean) => UntypedBoolean;
//# sourceMappingURL=untypedBoolean.d.ts.map