 ...
 */
export declare const isUntypedString: (node: UntypedNode) => node is UntypedString;
/**
 ...
 */
export declare const createUntypedString: (value: string) => UntypedString;
//# sourceMappingURL=untypedString.d.ts.map