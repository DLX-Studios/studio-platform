 ...
 */
export const enableBackingStoreForSerializationWriterFactory = (serializationWriterFactoryRegistry, parseNodeFactoryRegistry, original) => {
    if (!original)
 ...
 */
export const enableBackingStoreForParseNodeFactory = (parseNodeFactoryRegistry, original) => {
    if (!original)
        throw new Error("Original must be specified");
    let result = original;
 ...
 */
const enableBackingStoreForParseNodeRegistry = (registry) => {
 ...
 */
const enableBackingStoreForSerializationRegistry = (registry) => {
    for (const [k, v] of registry.contentTypeAssociatedFactories) {
