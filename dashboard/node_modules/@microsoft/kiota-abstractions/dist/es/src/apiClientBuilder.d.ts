 ...
 * -------------------------------------------------------------------------------------------
 */
import { type ParseNodeFactory, ParseNodeFactoryRegistry, type SerializationWriterFactory, SerializationWriterFactoryRegistry } from "./serialization/index.js";
/**
 ...
 */
export declare const enableBackingStoreForSerializationWriterFactory: (serializationWriterFactoryRegistry: SerializationWriterFactoryRegistry, parseNodeFactoryRegistry: ParseNodeFactoryRegistry, original: SerializationWriterFactory) => SerializationWriterFactory;
/**
 ...
 */
export declare const enableBackingStoreForParseNodeFactory: (parseNodeFactoryRegistry: ParseNodeFactoryRegistry, original: ParseNodeFactory) => ParseNodeFactory;
