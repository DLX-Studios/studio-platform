...
ownership. Hardware-specific performance certification is deferred. The dated implementation
results and current JavaScript/filesystem limitation are recorded in
